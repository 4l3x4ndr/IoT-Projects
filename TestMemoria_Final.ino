...
unsigned long tiempoTranscurridoQ1;
unsigned long tiempoTranscurridoQ2;
unsigned long tiempoTranscurridoQ3;
unsigned long tiempoTranscurridoQ4;
unsigned long tiempoTranscurridoQ5;
...
if(!flagWaiting){ //Si no ha generado la pregunta aleatoria
   ...
   // Serial.println(question);
    ...
    switch (question) {
      ...
      Serial.print("\t"); 
      Serial.println("TIME ANALYSIS");

      //Question 1 time
        Serial.print("\t");   
        Serial.print("Question 1 time: ");
        Serial.print((tiempoTranscurridoQ1-tiempoInicial)/1000);
        Serial.print(" s");
        Serial.println(" ");

      //Question 2 time
        Serial.print("\t");   
        Serial.print("Question 2 time: ");
        Serial.print((tiempoTranscurridoQ2 - tiempoTranscurridoQ1)/1000);
        Serial.print(" s");
        Serial.println(" ");

      //Question 3 time
        Serial.print("\t");   
        Serial.print("Question 3 time: ");
        Serial.print((tiempoTranscurridoQ3 - tiempoTranscurridoQ1)/1000);
        Serial.print(" s");
        Serial.println(" ");

      //Question 4 time
        Serial.print("\t");   
        Serial.print("Question 4 time: ");
        Serial.print((tiempoTranscurridoQ4 - tiempoTranscurridoQ3)/1000);
        Serial.print(" s");
        Serial.println(" ");

      //Question 5 time
        Serial.print("\t");   
        Serial.print("Question 5 time: ");
        Serial.print((tiempoTranscurridoQ5 - tiempoTranscurridoQ4)/1000);
        Serial.print(" s");
        Serial.println(" ");
     ...
     //Total & Average time
        ...
        Serial.print(tiempoTranscurridoQ5/1000);
        Serial.print(" s");
        Serial.println(" "); 
        ...
        Serial.print((tiempoTranscurridoQ5/1000)/5); //5 es el # de preguntas realizadas
        Serial.print(" s");
        Serial.println(" "); 
  ...
  switch (question) {
    ...
    tiempoTranscurridoQ5=millis(); //Mismo tiempo total
